...
public class ArrayExample {
	...
	public void ex2() {
		...
		// 1) 인덱스를 이용한 초기화
		arr[0] = 100; // arr int[] 참조형 변수가 참조하고 있는 배열의 0번 인덱스에 100을 대입
		arr[1] = 200;
		arr[2] = 300;
		arr[3] = 400;
		...
		// int 10개를 저장하는 배열의 각 요소에 10,20,30 ~ 100 까지 대입
...
//		Arrays.toString(배열명) : 배열에 저장된 모든 값을 한 줄로 간단히 출
