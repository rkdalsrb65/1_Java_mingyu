...
public class OperatorExample4 {
	...
	public static void main(String[] args) {
		...
		// &&(AND) 연산자 : 둘 다 true 일 때 true, 나머진 false
		...
		System.out.println("a는 100이상 이면서 짝수인가? " + (result1 && result2)); // false
		...
		// ||(OR) 연산자 : 둘 다 false 일 때 false, 나머진 true
		// 또는, ~거나, ~이거나
		...
		System.out.println("c는 홀수 이거나 10을 초과한 수 인가? ");
		...
		boolean result5 = (1 <= d && d <= 100) || (d < 0); // true
		
		
		System.out.println("d는 1부터 100 사이 숫자 또는 음수인가? " + (result5)); // true
