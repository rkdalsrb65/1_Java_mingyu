...
public class VariableExample3 {
	...
	public static void main(String[] args) {
		...
		/*
		 * boolean 1byte; - 논리 byte 1byte; - 정수 short 2byte; - 정수 int 4byte; - 정수 기본형
		 * long 8byte; - 정수 float 4byte; - 실수 double 8byte; - 실수 기본형 char 2byte; - 문자
		 */
		...
		int Num1;
		/*
		 * int Num1; Duplicate local variable Num1 Num1 변수가 중복이다 (에러)
		 */
		 ...
		 * 2. 예약어를 사용하면 안 된다.
		 * 
		 * int int; int true; boolean final; char void;
		 */
...
//		 3. 숫자로 시작하면 안 된다.
		...
		int age1;
		/*
		 * int 1age; // Syntax error on taken "1", delete this token Syntax error : 문법
		 * 오류
		 */

		/*
		 * 4. 특수문자는 '_'와 '$'만을 허용한다. -> $는 내부클래스 사용 시 자동으로 붙는 기호 (직접 사용 X) -> _는 상수 단어
		 * 구분 외에는 사용 X
		 */
		double $dNum;
		float _f_num$;
//       long longNum!;  // 에러
		...
		/*
		 * 5. 여러 단어 이름은 단어의 첫 글자를 대문자로 한다. 단, 첫 시작 글자는 소문자로 하는 것이 관례이다. == 카멜 표기법(낙타등
		 * 표기법) 오류는 바랭하지 않음(개발자들 간의 약속/관례)
		 */
		...
		System.out.println(name + "님은 " + age + "세 " + gender + "성입니다."); // 강민규님은 27세 남성입니다.
		...
		int CONSTANT_NUMBER = 100000000; // 1억
		// 마지막으로 값을 대입하는 변수 = 다시는 값을 대입 받지 않겠따
		// 변하지 않는 수(상수)
		
		// CONSTANT_NUMBER = 0;  -> 상수를 2번 쓰면 에러
